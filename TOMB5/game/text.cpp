...
static void AccentToCode(uchar& s)
{
    ...
    else if (s == static_cast<uchar>(191))  s = 128 + 40; // ¿
    else if (s == static_cast<uchar>(209))  s = 128 + 37; // Ñ
    else if (s == static_cast<uchar>(241))  s = 128 + 36; // ñ
    else if (s == static_cast<uchar>(250))  s = 128 + 35; // ú
    else if (s == static_cast<uchar>(243))  s = 128 + 34; // ó
    else if (s == static_cast<uchar>(237))  s = 128 + 33; // í
    else if (s == static_cast<uchar>(225))  s = 128 + 32; // á
    else if (s == static_cast<uchar>(211))  s = 128 + 28; // Ó
    else if (s == static_cast<uchar>(220))  s = 128 + 26; // Ü
    else if (s == static_cast<uchar>(214))  s = 128 + 25; // Ö
    else if (s == static_cast<uchar>(255))  s = 128 + 24; // ÿ
    else if (s == static_cast<uchar>(249))  s = 128 + 23; // ù
    else if (s == static_cast<uchar>(251))  s = 128 + 22; // û
    else if (s == static_cast<uchar>(242))  s = 128 + 21; // ò
    else if (s == static_cast<uchar>(246))  s = 128 + 20; // ö
    else if (s == static_cast<uchar>(244))  s = 128 + 19; // ô
    else if (s == static_cast<uchar>(193))  s = 128 + 17; // Á
    else if (s == static_cast<uchar>(201))  s = 128 + 16; // É
    else if (s == static_cast<uchar>(194))  s = 128 + 15; // Â
    else if (s == static_cast<uchar>(196))  s = 128 + 14; // Ä
    else if (s == static_cast<uchar>(236))  s = 128 + 13; // ì
    else if (s == static_cast<uchar>(238))  s = 128 + 12; // î
    else if (s == static_cast<uchar>(239))  s = 128 + 11; // ï
    else if (s == static_cast<uchar>(232))  s = 128 + 10; // è
    else if (s == static_cast<uchar>(235))  s = 128 + 9;  // ë
    else if (s == static_cast<uchar>(234))  s = 128 + 8;  // ê
    else if (s == static_cast<uchar>(231))  s = 128 + 0;  // ç
    else if (s == static_cast<uchar>(225))  s = 128 + 6;  // á (ripetuto)
    else if (s == static_cast<uchar>(224))  s = 128 + 5;  // à
    else if (s == static_cast<uchar>(228))  s = 128 + 4;  // ä
    else if (s == static_cast<uchar>(226))  s = 128 + 3;  // â
    else if (s == static_cast<uchar>(233))  s = 128 + 2;  // é
    else if (s == static_cast<uchar>(252))  s = 128 + 1;  // ü
}
