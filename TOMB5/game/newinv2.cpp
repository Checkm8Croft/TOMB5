...
{
	//main items
	{UZI_ITEM, -4, 0x3E8, 0x4000, 0x6000, 0x4000, 2, TXT_Uzi, static_cast<ulong>(-1)},
    {PISTOLS_ITEM, 6, 0x3E8, 0x4000, static_cast<short>(0xAD4C), static_cast<short>(0xBD40), 2, TXT_Pistols, static_cast<ulong>(-1)},
    {SHOTGUN_ITEM, -6, 0x280, static_cast<short>(0x8000), static_cast<short>(0xC000), 0x2000, 2, TXT_Shotgun, 1},
    {CROSSBOW_AMMO2_ITEM, 0, 0x44C, 0x4000, static_cast<short>(-0x1000), 0, 2, TXT_GRAP2, static_cast<ulong>(-1)},
    {CROSSBOW_AMMO2_ITEM, 0, 0x44C, 0x4000, static_cast<short>(-0x1000), 0, 2, TXT_GRAP2, static_cast<ulong>(-1)},
    {HK_ITEM, 0, 0x320, 0, static_cast<short>(0xC000), 0, 2, TXT_HKSTRING0, static_cast<ulong>(-1)},
    {HK_ITEM, 0, 0x320, 0, static_cast<short>(0xC000), 0, 2, TXT_HKSTRING1, static_cast<ulong>(-1)},
    {SHOTGUN_AMMO1_ITEM, 0, 0x1F4, 0x4000, 0, 0, 2, TXT_Shotgun_Normal_Ammo, static_cast<ulong>(-1)},
    {SHOTGUN_AMMO2_ITEM, 0, 0x1F4, 0x4000, 0, 0, 2, TXT_Shotgun_Wideshot_Ammo, static_cast<ulong>(-1)},
    ...
    {CROSSBOW_AMMO2_ITEM, 0, 0x44C, 0x4000, static_cast<short>(-0x1000), 0, 2, TXT_GRAP2, static_cast<ulong>(-1)},
    {CROSSBOW_AMMO2_ITEM, 0, 0x44C, 0x4000, static_cast<short>(-0x1000), 0, 2, TXT_GRAP2, static_cast<ulong>(-1)},
    {REVOLVER_AMMO_ITEM, 0, 0x2BC, 0x4000, static_cast<short>(-0xBB8), 0, 2, TXT_Revolver_Ammo, static_cast<ulong>(-1)},
    {UZI_AMMO_ITEM, 5, 0x2BC, 0, 0x1508, 0, 2, TXT_Uzi_Ammo, static_cast<ulong>(-1)},
    {PISTOLS_AMMO_ITEM, 4, 0x2BC, 0, 0x4000, 0, 2, TXT_Pistol_Ammo, static_cast<ulong>(-1)},
    {LASERSIGHT_ITEM, 2, 0x2BC, 0x4000, 0x7D0, 0, 2, TXT_LaserSight, static_cast<ulong>(-1)},
    {SILENCER_ITEM, 1, 0x384, 0, 0x7D0, 0, 2, TXT_Silencer, static_cast<ulong>(-1)},
    {BIGMEDI_ITEM, 2, 0x320, 0, 0, 0, 2, TXT_Large_Medipack, static_cast<ulong>(-1)},
    {SMALLMEDI_ITEM, 0, 0x200, 0, 0x5000, 0, 2, TXT_Small_Medipack, static_cast<ulong>(-1)},
    {BINOCULARS_ITEM, -1, 0x2BC, 0x1000, 0x7D0, 0, 2, TXT_Binoculars, static_cast<ulong>(-1)},
    {FLARE_INV_ITEM, 2, 0x44C, 0x4000, 0, 0, 2, TXT_Flares, static_cast<ulong>(-1)},
    {COMPASS_ITEM, 2, 0x44C, static_cast<short>(0x8000), 0, 0, 2, TXT_TMX, static_cast<ulong>(-1)},
    {PC_LOAD_INV_ITEM, 52, 0x898, static_cast<short>(0x8000), 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PC_SAVE_INV_ITEM, 52, 0x898, static_cast<short>(0x8000), 0, 0, 2, TXT_Save, static_cast<ulong>(-1)},

    // puzzles and their combines
    {PUZZLE_ITEM1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM2, 14, 0x258, 0, static_cast<short>(0xC000), 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM3, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM4, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM5, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM6, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM7, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM8, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},

    {PUZZLE_ITEM1_COMBO1, 18, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM1_COMBO2, 18, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM2_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM2_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM3_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM3_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM4_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM4_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM5_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM5_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM6_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM6_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM7_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM7_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM8_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
    {PUZZLE_ITEM8_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},

	//keys and their combines
	{KEY_ITEM1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM3, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM4, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM5, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM6, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM7, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM8, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},

	{KEY_ITEM1_COMBO1, 18, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM1_COMBO2, 18, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM2_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM2_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM3_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM3_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM4_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM4_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM5_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM5_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM6_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM6_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM7_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM7_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM8_COMBO1, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{KEY_ITEM8_COMBO2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},

	//pickup items and their combines
	{PICKUP_ITEM1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM2, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM3, 8, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM4, 2, 0x320, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM1_COMBO1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM1_COMBO2, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM2_COMBO1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM2_COMBO2, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM3_COMBO1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM3_COMBO2, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM4_COMBO1, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{PICKUP_ITEM4_COMBO2, 14, 0x4B0, 0, 0, 0, 2, TXT_Load, static_cast<ulong>(-1)},

	//the rest
	{BURNING_TORCH_ITEM, 14, 0x4B0, 0, 0x4000, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{CROSSBOW_ITEM, 0, 0x384, 0x2000, static_cast<short>(0x1800), 0, 2, TXT_GRAP1, 1},
	{EXAMINE1, 4, 0x514, 0, 0x4000, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{EXAMINE2, 14, 0x4B0, 0, 0x4000, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{EXAMINE3, 14, 0x4B0, 0, 0x4000, 0, 2, TXT_Load, static_cast<ulong>(-1)},
	{WET_CLOTH, -50, 0x200, 0x4000, 0x3000, 0x5000, 2, TXT_Wet_Cloth, static_cast<ulong>(-1)},
	{CROSSBOW_ITEM, 0, 0x384, 0x2000, static_cast<short>(0x1800), 0, 2, TXT_GRAP1, 1},
	{CROSSBOW_AMMO1_ITEM, 0, 0x44C, 0x4000, static_cast<short>(-0x1000), 0, 2, TXT_GRAP2, static_cast<ulong>(-1)},
	{CLOTH, -50, 0x200, 0x4000, 0x3000, 0x5000, 2, TXT_Cloth, static_cast<ulong>(-1)},
    {BOTTLE, 50, 0x320, static_cast<short>(0xC000), 0, 0, 2, TXT_Bottle, static_cast<ulong>(-1)},
    {PUZZLE_HOLE8, -10, 0x180, static_cast<short>(0xC000), 0x6800, static_cast<short>(0xC000), 10, TXT_Bottle, static_cast<ulong>(-1)}
};
#pragma warning(pop)
