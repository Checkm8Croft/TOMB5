...
void ConvertSurfaceToTextures(Surface surface);
void FreeMonoScreen();
void S_DrawTile(long x, long y, long w, long h, GLuint texture, long tU, long tV, long tW, long tH, long c0, long c1, long c2, long c3);
